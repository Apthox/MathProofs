...
J = np.matrix([[(X1*Y*c1/(X1 + 1)**2 - X1*Z*l/(X1 + 1)**2 - X1*e**(-H*ke)*j/(X1 + 1)**2 - Y*c1/(X1 + 1) + Z*l/(X1 + 1) - d + e**(-H*ke)*j/(X1 + 1)),
0,
-X1*c1/(X1 + 1),
X1*l/(X1 + 1)],
[0,
 (X2*Y*c2/(X2 + 1)**2 - X2*Z*f2/(X2 + 1)**2 - X2*c*e**(-H*ke)*h2/(X2 + 1)**2 - Y*c2/(X2 + 1) + Z*f2/(X2 + 1) + c*e**(-H*ke)*h2/(X2 + 1) - e2),
-X2*c2/(X2 + 1),
X2*f2/(X2 + 1)],
[Y*b*(-Y/n + 1)/(Y + 1),
0,
